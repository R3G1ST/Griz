...
// Удаляем все старые маршруты системы
const oldRoutesRegex = /\/\/ --- Управление системой ---[\s\S]*?router\.get\("\/system\/logs".*?\}\);\n\}\);/g;
code = code.replace(oldRoutesRegex, '');

// Добавляем правильные маршруты
const newRoutes = `
